...
После первой работы вышел на фриланс - это был период интенсивного изучения современных технологий и перехода на Python backend. Изучил FastAPI, Docker, asyncio, работал с различными API, экспериментировал с LLM и создавал интересные pet-проекты.
...
export const principles = [
  {
    ...
    description: 'Беру на себя сложные технические вызовы — от оптимизации БД до внедрения real-time систем и ML интеграций. Люблю разбираться в архитектуре и находить элегантные решения.',
  },
  {
    id: 2,
    icon: '⚡',
